        ...
        <div id="container">
            <div id="content">
                ...
                <div id="bbs">
                    ...
                    <form id="writeForm" action="boardwrite"
                        method="post"
                        enctype="application/x-www-form-urlencoded">
                        <div>
                            <p>
                                Borad Code : <input type="text"
                                    id="boardcd" name="boardcd" value="${board.boardcd }"/>
                            </p>
                        </div>
                        ...
                        <div>
                            <p>
                                Board Name : <input type="text"
                                    id="boardnm" name="boardnm"  value="${board.boardnm }"/>
                            </p>
                        </div>
                        ...
                        <div>
                            <p>
                                Use YN : <input type="checkbox"
                                    id="UseYN" name="UseYN" <c:if test="${board.UseYN }">checked="checked"</c:if>/>
                            </p>
                        </div>

                        <div>
                            <input id="btnSubmit" type="submit"
                                value="전송" /> <input id="btnList"
                                type="button" value="목록"
                                onclick="window.location.href='/board/boardlist';" />
