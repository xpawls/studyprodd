...
public class jv10_01_ArrayList {
    ...
    public static void main(String[] args) {
         ...
         * 검색: "자바 arraylist 크기"
         * */
        System.out.println("list 를 for문으로 출력 >>");
         ...
         * */
        System.out.println("list 를 for each문으로 출력 >>");
        ...
        System.out.println("S: 검색 첫번째 APPLE 방번호 >> "+pos); // R
        ...
        list.removeAll(list);
        System.out.println("D: list의 값을 모두 삭제 >> " + list);
